                                                ...
                                                <ul >
                                                    <li id="li_1" >
                                                  	...
                                                  	<li id="li_15" >
                                                        ...
                                                        <select class="element select small" id="element_15" name="shift" required/>
                                                        ...
                                                        <div>
                                                            <select class="element select small" id="element_16" name="hnumber" required/>
                                                            <option disabled selected value> -- select -- </option>
...
<?php endwhile; ?>
                                                        ...
                                                        <div>
                                                            <select class="element select small" id="element_18" name="m2size" required/>
                                                         <option disabled selected value> -- select-- </option>
                                                            <?php
// mysql select query
                                                            $query = "SELECT * FROM `size`";
...
<?php endwhile; ?>
                                                    ...
                                                    <!--    </div>-->
                                                        ...
                                                        <li id="li_4" >
                                                            ...
                                                            <div>
                                                                <input id="element_4" name="dependent_mr" class="element text medium" type="text" maxlength="6" value="" onkeypress="return IsNumeric(event);"/>
                                                        ...
                                                        <li id="li_5" >
                                                            ...
                                                            <div>
                                                                <input id="element_5" name="independent_mr" class="element text medium" type="text" maxlength="6" value="" onkeypress="return IsNumeric1(event);"/>
                                                        ...
                                                        <li id="li_6" >
                                                            ...
                                                            <div>
                                                                <input id="element_6" name="cutting" class="element text medium" type="text" maxlength="6" value="" onkeypress="return IsNumeric2(event);"/>
                                                            ...
                                                            <div>
                                                                <input id="element_7" name="avg_3mtr" class="element text medium" type="text" maxlength="6" value="" onkeypress="return IsNumeric3(event);"/>
                                                        ...
                                                        <li id="li_10" >
                                                            ...
                                                            <div>
                                                                <input id="element_10" name="avg_6mtr" class="element text medium" type="text" maxlength="6" value=""  onkeypress="return IsNumeric4(event);"/>
                                                        ...
                                                        <li id="li_9" >
                                                            ...
                                                            <div>
                                                                <input id="element_9" name="bp_3mtr" class="element text medium" type="text" maxlength="6" value="" onkeypress="return IsNumeric5(event);"/>
                                                        ...
                                                        <li id="li_8" >
                                                            ...
                                                            <div>
                                                                <input id="element_8" name="bp_6mtr" class="element text medium" type="text" maxlength="6" value="" onkeypress="return IsNumeric6(event);
                                                                        "/>
...
<?php endwhile; ?>
                                                            ...
                                                            <div>
                                                               ...
                                                               <option disabled selected value> -- select an option -- </option>
                                                                ...
                                                                <?php
// mysql select query
                                                                $query = "SELECT * FROM `person` where shiftformen = true ";
// for method 1
                                                                $result1 = mysqli_query($link, $query);
                                                                ?>
<?php while ($row1 = mysqli_fetch_array($result1)):; ?>
